...
describe('message reducer pending actions', () => {
  it('should handle GET_ARCADE_STATE_PENDING', () => {
    ...
    expect(reducer(initialState, pendingAction)).toEqual(messages.Loading);
  });
...
describe('message reducer fulfilled actions', () => {
  ...
  it('should handle UPLOAD_FULFILLED', () => {
    const fulfilledAction = {
      ...
      payload: messages.UploadScoreSuccess,
    };
    expect(reducer(initialState, fulfilledAction)).toEqual(messages.UploadScoreSuccess);
  });
  ...
  it('should handle MOVE_FULFILLED on gameover', () => {
    ...
    expect(reducer(initialState, fulfilledAction)).toEqual(messages.GameOver);
  });
});
...
describe('message reducer rejected actions', () => {
  it('should handle GET_ARCADE_STATE_REJECTED', () => {
    ...
    expect(reducer(initialState, rejectedAction)).toEqual(expectedOutput);
  });
